...
const CACHE = "daily-chapter-v44";
const SHELL = ["./", "./index.html", "./kings.html", "./manifest.webmanifest", "./apple-touch-icon.png", "./icon-192.png", "./icon-512.png", "../pull.js", "../marks.js", "../notion-sync.js"];
